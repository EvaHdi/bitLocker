...
logging = LoggerManager(log_dir="..\script_log\\",
                        log_name=f"t_Tcg_BitLocker_14_RebootAPL_{current_time}").get_logger()
...
class RebootAPL():
    ...
    def __init__(self):
        ...
        self.target_script = "test_case\\t_Tcg_BitLocker_14_RebootAPL.py"  # 修改为目标脚本名
        self.script = "t_Tcg_BitLocker_14_RebootAPL.py"
    ...
    def Run(self):
        ...
        try:
            if state.get("stage") == "enable":
                ...
                logging.info("step 2: delay power off")
                port = 'COM4'  # 串口名称
                delay_seconds = 2
