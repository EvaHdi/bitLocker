...
logging = LoggerManager(log_dir="..\script_log\\",
                        log_name=f"t_Tcg_BitLocker_22_BaseRebootIoFormat_{current_time}").get_logger()

class BaseRebootIoFormat():
    ...
    def __init__(self):
        ...
        self.target_script = "test_case\\t_Tcg_BitLocker_22_BaseRebootIoFormat.py"  # 修改为目标脚本名
        self.script = "t_Tcg_BitLocker_22_BaseRebootIoFormat.py"
    ...
    def Run(self):
        ...
        try:
            if state.get("stage") == "enable":
                ...
                logging.info("Step 2: FIO read write")
                test_dir = "D:\\fio_test"
                test_file = "testfile"
                fio_path = "fio.exe"
