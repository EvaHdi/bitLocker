...
logging = LoggerManager(log_dir="..\script_log\\",
                        log_name=f"t_Tcg_BitLocker_21_BaseRebootIoTest_{current_time}").get_logger()

class BaseRebootIoTest():
    ...
    def __init__(self):
        ...
        self.target_script = "test_case\\t_Tcg_BitLocker_21_BaseRebootIoTest.py"  # 修改为目标脚本名
