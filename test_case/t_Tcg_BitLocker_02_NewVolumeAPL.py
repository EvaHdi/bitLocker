...
"""
<SCRIPTNAME>t_Tcg_BitLocker_02_NewVolumeAPL.py</SCRIPTNAME>
...
logging = LoggerManager(log_dir="..\script_log\\", log_name=f"t_Tcg_BitLocker_02_NewVolumeAPL_{current_time}").get_logger()
...
class NewVolumeAPL():
    ...
    def verify_locked(self, drive_letter="D://"):
        ...
        try:
            ...
            logging.info("写入失败，卷可能被锁定。")
        except OSError as e:
            logging.info(f"写入失败，错误信息：{e}")
